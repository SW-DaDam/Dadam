...
- memory_recall: 과거 추억 회상 (옛날 이야기, 어릴 때, 예전에)
- emotional_peak: 감정이 강하게 표현된 발화 (기쁨, 슬픔, 그리움, 감동)
- philosophy: 삶의 가치관, 신념, 교훈 (그래야 해, 살다 보면, 중요한 건)
- relationship_event: 가족·지인과의 관계 사건 (손자가, 며느리가, 이웃이)
